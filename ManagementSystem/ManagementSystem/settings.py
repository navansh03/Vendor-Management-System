...
#The secret key can be hidden in env file but for the sake of simplicity and viewing for this task , it is kept here.
SECRET_KEY = 'django-insecure-go^88rn+-w%8_$o1wvt^fb_p11%uuv76ne!-a1-of#*8*t(@@='
